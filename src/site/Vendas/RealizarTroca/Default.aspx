<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="Default.aspx.cs" Inherits="Vendas_RealizarTroca_Default" %>
				...
				<asp:Repeater runat="server" ID="rpProdutos">
					...
					<ItemTemplate>
						<tr>
							...
							<td>
								<asp:LinkButton ID="LinkButton1" runat="server" CssClass="btnExcluir" Width="16" CausesValidation="false" CommandArgument='<%# Eval("IdProduto") %>'
